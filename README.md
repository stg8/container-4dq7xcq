...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4dq7xcq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4dq7xcq.containers.anotherwebservice.com/
...
```
git clone git@github.com:stg8/container-4dq7xcq.git
cd container-4dq7xcq
```
...
```
docker attach container-4dq7xcq
```
